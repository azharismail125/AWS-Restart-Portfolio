...
![Launching CLI through EC2](Labs/S3/Screenshots/1_Launching_CLI_through_EC2.png)
...
![Configuring CLI](Labs/S3/Screenshots/2_Configuring_CLI_redacted.png)
...
![Bucket creation through S3](Labs/S3/Screenshots/3_Bucket_creation_through_S3.png)

## 4. Upload files
**Via console:**
- Used the **Upload** button to add `file1.txt` (44.0 B) — succeeded.

![Uploading file to S3](Labs/S3/Screenshots/4_1_Uploading_file_to_S3.png)
...
![Creating and adding file to S3 bucket from CLI](Labs/S3/Screenshots/4_2_Creating_and_adding_file_to_s3_bucket_from_CLI_redacted.png)
...
![Upload to bucket confirmed](Labs/S3/Screenshots/5_Upload_to_bucket_confirmed.png)

## 5. Enable static website hosting
In bucket **Properties** tab → **Static website hosting** → enabled, set index document (`index.html`).

![Static hosting enabled](Labs/S3/Screenshots/6_Static_hosting_enabled.png)
...
![Enabled Public Access](Labs/S3/Screenshots/7_Enabled_Public_Access.png)
...
![Added Bucket policy for website viewing](Labs/S3/Screenshots/8_Added_Bucket_policy_for_website_viewing.png)
...
![Viewing object in web browser](Labs/S3/Screenshots/9_Viewing_obkect_in_web_browser.png)
