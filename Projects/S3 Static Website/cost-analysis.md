...
Of the three, data transfer out is almost always the dominant cost for a live site — storage and requests stay cheap even at scale, but as each visitor downloads the page's files, data transfer [...]
...
For a small local gym's marketing site with modest traffic (roughly a few thousand visitors per month) and optimized images, the realistic cost is under R100/month on S3 alone. Traffic combined wi[...]
